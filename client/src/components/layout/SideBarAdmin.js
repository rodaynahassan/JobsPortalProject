            ...
            >
                ...
                <SideNav.Nav>
                    <NavItem eventKey="personalInfo" title="Personal Info">
                        ...
                        <NavText>
                            <a style={{ paddingRight:"90px" ,fontSize:"15px" }}href="/admininfo">Personal Info</a>
                        </NavText>
                    </NavItem>

                    <NavItem eventKey="changeEmail" title="Change your email">
                        <NavIcon>
                            <a href="/adminchangeemail">
                            <i className="fa fa-at" style={{ fontSize: '1.75em',color:"#3C54F5"}} > </i>
                            </a>
                        </NavIcon>
                        <NavText>
                            <a style={{ paddingRight:"50px" ,fontSize:"15px" }}href="/adminchangeemail">Change your email</a>
                        </NavText>
                    </NavItem>
                    ...
                    <NavItem eventKey="chnagePassword" title="Change Password">
                        ...
                        <NavText>
                            <a style={{ paddingRight:"25px" ,fontSize:"15px" }}href="/adminchangepassword">Change your password</a>
                        </NavText>
                    </NavItem>
                </SideNav.Nav>
            </SideNav>
