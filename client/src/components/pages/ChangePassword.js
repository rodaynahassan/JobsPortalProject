...
class ChanagePassword extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
            oldPassword:'',
...
handleClick(event) {
	...
	var apiBaseUrl = '/routes/api/jobSeekers/changePassword/5e7d35d36626c516005f62a1';
	var payload = {
	...
	axios
		...
		.then(res => {
            swal(res.data.msg)
            setTimeout("document.location.href = '/changepassword';",1500);
