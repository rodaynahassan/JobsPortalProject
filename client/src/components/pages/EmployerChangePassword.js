...
class EmployerChangePassword extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
            oldPassword:'',
...
handleClick(event) {
	...
	var apiBaseUrl = '/routes/api/employers/changePassword/5ed02ba21a7ba21e60d0d064';
	var payload = {
	...
	axios
		...
		.then(res => {
            swal(res.data.msg)
            setTimeout("document.location.href = '/employerchangepassword';",1500);
